...
class dsr_eligible_fraction_bourg_centre_type_1(Variable):
    ...
    def formula(commune, period, parameters):
        ...
        # Restent des sources d'exclusion de l'éligibilité...
        ...
        dsr_bc_part_max_pop_departement = paremetres_dsr.bourg_centre.eligibilite.exclusion.seuil_part_population_dgf_departement_agglomeration
        dsr_bc_pop_max_agglo = paremetres_dsr.bourg_centre.eligibilite.exclusion.seuil_population_dgf_agglomeration
        dsr_bc_taille_max_plus_grande_commune_agglo = paremetres_dsr.bourg_centre.eligibilite.exclusion.seuil_population_dgf_maximum_commune_agglomeration

        eligible = (preeligible
            * (population_dgf_agglomeration < min_(dsr_bc_pop_max_agglo, dsr_bc_part_max_pop_departement * population_dgf_departement_agglomeration))
        ...
        dsr_bc_taille_max_chef_lieu_canton = paremetres_dsr.bourg_centre.eligibilite.exclusion.seuil_population_dgf_chef_lieu_de_canton
        eligible = eligible * ((population_dgf_chef_lieu_de_canton < dsr_bc_taille_max_chef_lieu_canton) | bureau_centralisateur)
        ...
        dsr_bc_ratio_max_pot_fin = paremetres_dsr.bourg_centre.eligibilite.exclusion.seuil_rapport_pfi_10000

        # On pourrait en créer une variable, on va l'utiliser 3 fois dans 3 fonctions différentes.
        # Ou alors un paramètre calculable ?
        ...
        eligible = eligible * (potentiel_financier_par_habitant < (dsr_bc_ratio_max_pot_fin * pot_fin_10000))
