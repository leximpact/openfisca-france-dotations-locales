...
class dsr_eligible_fraction_bourg_centre_type_1(Variable):
    ...
    def formula(commune, period, parameters):
        ...
        seuil_part_population_canton = parameters(period).dotation_solidarite_rurale.bourg_centre.eligibilite.seuil_part_population_canton
        outre_mer = commune('outre_mer', period)
        ...
        preeligible = (~outre_mer) * taille_eligible * ((part_population_canton >= seuil_part_population_canton) | bureau_centralisateur | chef_lieu_de_canton)
        ...
        dsr_bc_taille_max_chef_lieu_canton = parameters(period).dotation_solidarite_rurale.bourg_centre.eligibilite.exclusion.seuil_population_dgf_chef_lieu_de_canton
        ...
        dsr_bc_ratio_max_pot_fin = parameters(period).dotation_solidarite_rurale.bourg_centre.eligibilite.exclusion.seuil_rapport_pfi_10000
