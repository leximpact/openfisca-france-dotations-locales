...
These elements are described in different folders. All the modelling happens within the `openfisca_france_dotations_locales` folder.
...
```sh
pip install openfisca_france_dotations_locales
```
...
```sh
git clone https://github.com/openfisca/openfisca-france_dotations_locales.git
cd openfisca-france_dotations_locales
...
Substitute your package's country name for `openfisca_france_dotations_locales` below:
